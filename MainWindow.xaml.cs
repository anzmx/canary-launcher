...
namespace CanaryLauncherUpdate
{
	...
	public partial class MainWindow : Window
	{
		...
		private void TibiaLauncher_Load(object sender, RoutedEventArgs e)
		{
			...
			if (File.Exists(path + "/client/version.txt"))
			{
				StreamReader reader = new StreamReader(path + "/client/version.txt");
		...
		{
			string json = path + "/client/package.json";
		...
		private void buttonPlay_Click(object sender, RoutedEventArgs e)
		{
			...
			else
			{
				...
				{
					Process.Start(path + "/client/bin/" + clientName);
					this.Close();
				}
				else
				{
